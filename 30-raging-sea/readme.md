 ...
 void main()
{
    ...
    // for loop to make detailed waves - first i used for more frequency and last i for less elevation
    for(float i = 1.0; i <= uSmallWavesIterations; i++){
    // using abs and - to show the sharp surfaces of water
...
void main(){
    float mixStrength = (vElevation + uColorOffset) * uColorMultiplier; // wavas color strength
