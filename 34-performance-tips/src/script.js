...
//  you create only one InstancedMesh, and then you provide a transformation matrix for each "instance" of that mesh.
// const geometry = new THREE.BoxGeometry(0.5, 0.5, 0.5);
...
//   // Implementation of a quaternion. This is used for rotating things without incurring
//   // in the dreaded gimbal lock issue, amongst other advantages.
...
const shaderMaterial = new THREE.ShaderMaterial({
  precision: "lowp", // Specify the precision
  uniforms: {
