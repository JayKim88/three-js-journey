https://github.com/JayKim88/three-js-journey/assets/55373668/2c11918e-c24e-4dfd-a101-2e0cbec0e0f6
...
const tick = () => {
  ...
  // it make a ray caster to mouse points from camera !!
  ...
  // Test intersect with model duck
  if (model) {
